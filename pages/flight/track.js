      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Enter your flight number to get real-time updates, status information, and AI-powered insights.
          </p>
        </div>
        ...
        <div className="glass-effect p-6 rounded-2xl mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400">Upload your ticket PDF to automatically track all flights</p>
            </div>
            <Button
              variant="secondary"
              size="sm"
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`
                      ...
                      ${search.status === 'On Time' ? 'bg-green-500/10 text-green-400' : 
                        search.status === 'Delayed' ? 'bg-yellow-500/10 text-yellow-400' :
